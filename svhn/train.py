...
cnn_model = example.svhn(n_channel=args.channel)
cnn_model = torch.nn.DataParallel(cnn_model, device_ids= range(args.ngpu))
if args.cuda:
    cnn_model.cuda()

# optimizer
optimizer = optim.Adam(cnn_model.parameters(), lr=args.lr, weight_decay=args.wd)
...
try:
    ...
    torch.save(cnn_model.state_dict(), "../checkpoints/svhn.pt")
